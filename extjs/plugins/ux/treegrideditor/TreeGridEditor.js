...
//    },
    ...
    saveBtnsHtml: function(n) {
        ...
        r.push('<a hidefocus="on" href="javascript:void();" class="x-treegrideditor-obar-yes', '" onclick="Ext.getCmp(\'', this.id, '\').updateNode(\'', n.id, '\');return false;">', this.obarBtnText.save, '</a>');
        r.push('</span>');
        r.push('<span id="', this.getBtnId(n, Ext.ux.tree.TreeGridEditor.Obar.Api.cancel), '" unselectable="on">');
        r.push('<a hidefocus="on" href="javascript:void();" class="x-treegrideditor-obar-no', '" onclick="Ext.getCmp(\'', this.id, '\').cancelEdit(\'', n.id, '\');return false;">', this.obarBtnText.cancel, '</a>');
        r.push('</span>');
        return r.join('');
    },
    ...
    addNode: function(n) {
        ...
        return this.beginEdit(nn, this.onAddNode, [n]);
    },
...
//            }
//            
//            this.handleRequest(n, Ext.ux.tree.TreeGridEditor.Obar.Api.remove, undefined, function(res) {
